<?php
/**
The file to load the post content in Colorbox.
...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'riview' ), max( $paged, $page ) );
...
<div id="ri-page">
       ...
       <div id="ri-primary">
                ...
                <article id="ri-post-<?php echo $theID; ?>" <?php post_class('',$theID); ?>>
                        ...
                        <header class="ri-header">
                            ...
                            <div class="ri-entry-meta">
                                ...
                                <?php if ( comments_open() && ! post_password_required() ) : ?>
                                 | <span class="ri-leave-reply">
                                <?php comments_popup_link(  __( 'Reply', 'riview' ), _x( '1 Comment', 'comments number', 'riview' ), _x( '% Comments', 'comments number', 'riview' ) ); ?>
                                </span>
                            <?php endif; ?>
                    ...
                    <footer class="ri-entry-meta">
                        <?php $show_sep = false; ?>
                        <?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
                        <?php
                            /* translators: used between list items, there is a space after the comma */
                            $categories_list = get_the_category_list( __( ', ', 'riview' ) );
                            if ( $categories_list ):
                        ?>
                        <span class="ri-cat-links">
                            <?php printf( __( '<span class="%1$s">Posted in</span> %2$s', 'riview' ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list );
                            $show_sep = true; ?>
                        </span>
                        ...
                        <?php
                            /* translators: used between list items, there is a space after the comma */
                            $tags_list = get_the_tag_list( '', __( ', ', 'riview' ) );
                            if ( $tags_list ):
							?>
                            <span class="ri-sep"> | </span>
                        <span class="ri-tag-links">
                            <?php printf( __( '<span class="%1$s">Tagged</span> %2$s', 'riview' ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list );
                            $show_sep = true; ?>
                        </span>
                        ...
                        <span class="ri-sep"> | </span>
                        <span class="ri-comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'riview' ) . '</span>', __( '<b>1</b> Reply', 'riview' ), __( '<b>%</b> Replies', 'riview' ) ); ?></span>
